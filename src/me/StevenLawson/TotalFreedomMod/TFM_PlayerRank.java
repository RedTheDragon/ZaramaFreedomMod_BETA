...
public enum TFM_PlayerRank
{
    ...
    ZFM_DEVELOPER("a " + ChatColor.DARK_PURPLE + "Developer", ChatColor.DARK_PURPLE + "(Dev)"),
    WEB_DEVELOPER("a " + ChatColor.GREEN + "Web Developer", ChatColor.GREEN + "(Web Dev)"),
    SPEC_EXEC("a " + ChatColor.YELLOW + "Special Executive", ChatColor.YELLOW + "(Spec-Executive)"),
  RED("the " + ChatColor.DARK_PURPLE + "Lead Developer", ChatColor.DARK_PURPLE + "(Lead Dev)"),
    ...
    public static TFM_PlayerRank fromSender(CommandSender sender)
    {
        ...
        else if (sender.getName().equals("SupImZarama"))
        {
            return FOUNDER;
        }
